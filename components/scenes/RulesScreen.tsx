        ...
        <div className="nj-phone">
          ...
          <div className="nj-stack">
            <RuleCard icon="cards" tone="gold" title="But du jeu">
              ...
              ni As). Chaque joueur reçoit <b style={{ color: "var(--nj-solar-ink)" }}>{cfg.cardsPerPlayer} cartes</b>.
              Tout le monde mise, et le vainqueur de la manche rafle le <b style={{ color: "var(--nj-solar-yellow-deep)" }}>pot</b>.
            </RuleCard>

            <RuleCard icon="spark" tone="teal" title="La tendance">
              Le premier joueur pose une carte : sa couleur devient la <b style={{ color: "var(--nj-solar-ink)" }}>tendance</b>.
              Les autres <b style={{ color: "var(--nj-solar-ink)" }}>doivent suivre</b> la couleur menée s&apos;ils en ont.
            ...
            <RuleCard icon="crown" tone="gold" title="Dominer un tour">
              La <b style={{ color: "var(--nj-solar-ink)" }}>plus forte carte de la tendance</b> remporte le tour.
            ...
            <RuleCard icon="trophy" tone="pink" title="Victoires instantanées">
              ...
              <ul style={{ margin: "8px 0 0", paddingLeft: 18, display: "grid", gap: 4 }}>
                <li>Somme des cartes <b style={{ color: "var(--nj-solar-ink)" }}>&lt; {cfg.instantWin.sumBelow}</b> → victoire immédiate.</li>
                <li>Somme <b style={{ color: "var(--nj-solar-ink)" }}>= {cfg.instantWin.sumExactDoubles}</b> → victoire <b style={{ color: "var(--nj-solar-yellow-deep)" }}>doublée</b>.</li>
                {cfg.instantWin.flushWins && (
                  <li><b style={{ color: "var(--nj-solar-ink)" }}>5 cartes d&apos;une même couleur</b> → victoire immédiate.</li>
                )}
              </ul>
            </RuleCard>
            ...
            {cfg.lastCardThreeDoubles && (
              <RuleCard icon="coin" tone="gold" title="Le 3 du dernier tour">
                Dominer le <b style={{ color: "var(--nj-solar-ink)" }}>dernier tour avec un 3</b> double les gains :
                chaque adversaire paie une mise de plus au gagnant.
              </RuleCard>
            )}

            <RuleCard icon="settings" tone="cobalt" title="Rythme & mises">
              Tu as <b style={{ color: "var(--nj-solar-ink)" }}>{cfg.turnSeconds}s</b> par tour ; au-delà, ta plus
